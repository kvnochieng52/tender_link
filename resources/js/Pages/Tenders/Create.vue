...
const applyInstitutionSelectionState = () => {
  // Reset edit mode whenever selection changes
...
<template>
  ...
  <DashboardLayout>
    ...
    <form @submit.prevent="submit" class="tender-form-sections">
          ...
          <div v-if="form.files.length" class="mt-3">
            ...
            >
              <div class="text-truncate pr-2">
                <i class="far fa-file-alt mr-2 text-success"></i>{{ file.name }}
              </div>
              <button
                type="button"
      ...
      <div
        class="d-flex flex-wrap justify-content-end mt-5 mb-4 submit-action-row"
      >
        <button
          type="submit"
