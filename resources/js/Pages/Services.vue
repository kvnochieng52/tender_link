...
const mainServices = [
    {
        ...
        features: ["Real-time tender feed", "Email & digest notifications", "County and industry filters"],
    },
    {
        step:  "02",
        ...
        features: ["Multi-file document upload", "Submission tracking", "Instant email confirmation"],
    },
    {
        step:  "03",
        ...
        features: ["Configurable scoring rubrics", "Side-by-side comparison", "Full audit trail"],
    },
    {
        step:  "04",
        icon:  "fas fa-award",
        ...
        features: ["Auto-generated award letters", "Bulk applicant notifications", "Compliance documentation"],
    },
];

const addOnServices = [
    { icon: "fas fa-chart-bar",  title: "Analytics & Reporting",  text: "Dashboards showing tender performance, application volumes, popular categories, and revenue insights for administrators." },
    { icon: "fas fa-users-cog",  title: "Supplier Management",    text: "Manage supplier profiles, verify credentials, and maintain a pre-qualified supplier register for repeat procurement." },
    { icon: "fas fa-credit-card",title: "Subscriptions & Billing", text: "Flexible monthly, quarterly, and annual plans with M-Pesa and card payment channels for fast onboarding." },
    { icon: "fas fa-shield-alt", title: "Compliance & Security",   text: "Role-based access, encrypted document storage, and anti-scraping measures keep your data and processes safe." },
    { icon: "fas fa-headset",    title: "Dedicated Support",       text: "Chat, email, and phone support with dedicated account managers for institutional clients." },
    { icon: "fas fa-code",       title: "API Integrations",        text: "Connect Tender Link to your ERP, accounting system, or government procurement portal via our RESTful API." },
];
...
const plans = [
    {
        ...
        period: "/month",
        badge: "Starter",
        features: ["Access all tenders", "5 applications/month", "Email alerts", "Document upload"],
        highlighted: false,
    },
    {
        name:  "Professional",
        ...
        period: "/quarter",
        badge: "Most Popular",
        features: ["Unlimited applications", "Priority alerts (email + SMS)", "Evaluation dashboard", "Supplier analytics", "Dedicated support"],
        highlighted: true,
    },
    {
        name:  "Enterprise",
        ...
        period: "",
        badge: "Best Value",
        features: ["Everything in Professional", "API access", "White-label options", "SLA guarantee", "On-site training"],
        highlighted: false,
    },
];
</script>
...
<template>
    ...
    <div class="landing-page bg-light">
        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div :class="['nav-mobile-collapse', mobileMenuOpen ? 'is-open' : '']">
                <ul class="navbar-nav nav-main-menu flex-row flex-wrap justify-content-center my-2 my-lg-0 mx-lg-auto">
                    ...
                    <li class="nav-item">
                        <Link :href="route('services')" class="nav-link active" @click="closeMobileMenu">Services</Link>
                    </li>
        ...
        <main class="pb-5">
                ...
                <div class="services-hero-overlay">
                    <div class="container text-center">
                        ...
                        <p class="services-hero-sub">
                            Everything you need to discover, apply for, evaluate, and award tenders — on one secure platform.
                        </p>
                        <Link :href="route('register')" class="btn btn-success btn-lg px-5 mt-2">
            ...
            <section class="py-5">
                <div class="container">
                    <div class="section-header text-center mb-5">
                        <span class="badge badge-success-soft mb-2"><i class="fas fa-cogs mr-1"></i>Core Platform</span>
                        <h2 class="font-weight-bold" style="color:#1a3a22">End-to-End Procurement Services</h2>
                        <p class="text-muted mx-auto" style="max-width:560px">
                            From the moment you post or discover a tender to the final award — Tender Link covers every step.
                        </p>
                    </div>
                    <div class="row">
                        <div v-for="svc in mainServices" :key="svc.step" class="col-sm-6 col-lg-3 mb-4">
            ...
            <!-- Add-on services -->
            <section class="py-5" style="background: linear-gradient(160deg, #f0faf4 0%, #e8f8ee 100%)">
                <div class="container">
                    <div class="section-header text-center mb-5">
                        <span class="badge badge-success-soft mb-2"><i class="fas fa-plus-circle mr-1"></i>Add-on Services</span>
                        <h2 class="font-weight-bold" style="color:#1a3a22">More Tools to Grow With</h2>
                        <p class="text-muted mx-auto" style="max-width:520px">
                            Extend your capabilities with these supplementary services, available on selected plans.
                        </p>
                    </div>
                    <div class="row">
                        <div v-for="addon in addOnServices" :key="addon.title" class="col-sm-6 col-lg-4 mb-4">
            ...
            <section class="py-5">
                <div class="container">
                    <div class="section-header text-center mb-5">
                        <span class="badge badge-success-soft mb-2"><i class="fas fa-tags mr-1"></i>Pricing</span>
                        <h2 class="font-weight-bold" style="color:#1a3a22">Simple, Transparent Plans</h2>
                        <p class="text-muted mx-auto" style="max-width:480px">
                            No hidden fees. Upgrade or downgrade any time.
                        </p>
                    </div>
                    <div class="row justify-content-center">
                        <div v-for="plan in plans" :key="plan.name" class="col-sm-10 col-md-6 col-lg-4 mb-4">
                            <div :class="['plan-card h-100', plan.highlighted ? 'plan-card--highlighted' : '']">
                                ...
                                <Link
                                    :href="route('register')"
                                    :class="['btn btn-block btn-sm px-4 mt-auto', plan.highlighted ? 'btn-success' : 'btn-outline-success']"
                                >
                                    Get Started
                                </Link>
                            </div>
            ...
            <section class="services-cta py-5">
                <div class="container text-center">
                    <h2 class="font-weight-bold text-white mb-3">Have a question about our services?</h2>
                    <p class="text-white-50 mb-4">Our team is ready to help you find the right plan for your needs.</p>
                    <div class="d-flex justify-content-center flex-wrap" style="gap:1rem">
                        <Link :href="route('contact')" class="btn btn-light btn-lg px-5 font-weight-bold" style="color:#28a745">
                            <i class="fas fa-envelope mr-2"></i>Contact Us
                        </Link>
                        <Link :href="route('register')" class="btn btn-outline-light btn-lg px-5">
...
.services-hero-title { font-size: 2.6rem; font-weight: 800; color: #fff; margin-bottom: .5rem; }
.services-hero-sub   { font-size: 1.1rem; color: rgba(255,255,255,.82); max-width: 580px; margin: 0 auto; }
...
.svc-card:hover { box-shadow: 0 6px 24px rgba(40,167,69,.13); }
.svc-step-badge {
    position: absolute;
    top: 1rem; right: 1rem;
...
.svc-title { color: #1a3a22; }
.svc-feature-list { list-style: none; padding: 0; margin: 0; font-size: .82rem; color: #495057; }
.svc-feature-list li { margin-bottom: .3rem; }
...
.addon-card:hover { box-shadow: 0 4px 16px rgba(40,167,69,.1); }
.addon-icon-wrap {
    width: 44px; height: 44px; border-radius: 50%;
    background: rgba(40,167,69,.1);
    display: flex; align-items: center; justify-content: center;
    font-size: 1.1rem; color: #28a745; margin-top: .1rem;
}
...
.plan-card--highlighted {
    border-color: #28a745;
    box-shadow: 0 8px 28px rgba(40,167,69,.18);
}
.plan-badge {
...
.plan-name   { font-size: 1.25rem; font-weight: 800; color: #1a3a22; margin-bottom: .25rem; }
.plan-price  { font-size: 1.8rem; font-weight: 800; color: #28a745; margin-bottom: 1.25rem; }
.plan-period { font-size: .85rem; font-weight: 500; color: #6c757d; }
.plan-feature-list {
    list-style: none; padding: 0; margin: 0 0 1.5rem;
    font-size: .85rem; color: #495057; flex: 1;
}
.plan-feature-list li { margin-bottom: .5rem; }

/* ── CTA ──────────── */
.services-cta { background: linear-gradient(135deg, #1a5c2e 0%, #28a745 100%); }

/* ── Badge soft ───── */
.badge-success-soft {
    background: rgba(40,167,69,.12); color: #1a6130;
    font-size: .8rem; font-weight: 600;
    padding: .35em .75em; border-radius: 99px;
}
