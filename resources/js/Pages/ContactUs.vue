...
const contactDetails = [
    { icon: "fas fa-map-marker-alt", label: "Address",  value: "Westlands Business Park, Nairobi, Kenya" },
    { icon: "fas fa-phone-alt",      label: "Phone",    value: "+254 700 000 000" },
    { icon: "fas fa-envelope",       label: "Email",    value: "hello@tenderlink.co.ke" },
    { icon: "fas fa-clock",          label: "Hours",    value: "Mon – Fri: 8:00 AM – 6:00 PM EAT" },
];

const faqs = [
    { q: "How do I register as a supplier?",              a: "Click the 'Register Free' button in the navigation bar, complete the form, verify your email, and choose a subscription plan." },
    { q: "Can I post tenders as an institution?",         a: "Yes. Contact our team through this form and we'll set up your institution account with admin access to create and manage tenders." },
    { q: "What payment methods are supported?",           a: "We accept M-Pesa, Visa, and Mastercard for subscription payments." },
    { q: "How quickly are tenders updated on the portal?", a: "New tenders are published within 24 hours of submission and are immediately searchable." },
    { q: "Is my submitted data secure?",                  a: "All documents are encrypted at rest and in transit. We follow OWASP security practices and conduct regular security audits." },
];
        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div :class="['nav-mobile-collapse', mobileMenuOpen ? 'is-open' : '']">
                <ul class="navbar-nav nav-main-menu flex-row flex-wrap justify-content-center my-2 my-lg-0 mx-lg-auto">
                    ...
                    <li class="nav-item">
                        <Link :href="route('contact')" class="nav-link active" @click="closeMobileMenu">Contact Us</Link>
                    </li>
                </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            <div class="contact-info-card h-100">
                                <h4 class="font-weight-bold mb-4" style="color:#1a3a22">Contact Information</h4>
                                <div v-for="detail in contactDetails" :key="detail.label" class="contact-detail-row mb-3">
                                ...
                                <p class="small font-weight-bold mb-2" style="color:#1a3a22">Follow us</p>
                                <div class="d-flex" style="gap:.65rem">
                            ...
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-header bg-white border-bottom py-3">
                                    <h5 class="mb-0 font-weight-bold" style="color:#1a3a22">
                                        <i class="fas fa-paper-plane text-success mr-2"></i>Send Us a Message
                                    </h5>
                                </div>
                                <div class="card-body p-4">
                                    ...
                                    <form @submit.prevent="send">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                <label class="small font-weight-bold mb-1">Email Address <span class="text-danger">*</span></label>
                                                <input
                                                    v-model="form.email"
                                                    type="email"
                                                    class="form-control form-control-sm"
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="small font-weight-bold mb-1">Subject <span class="text-danger">*</span></label>
                                            <select
                                            ...
                                            >
                                                ...
                                                <option value="Institution/Posting Account">Institution / Posting Account</option>
                                        ...
                                        <div class="form-group mb-4">
                                            <label class="small font-weight-bold mb-1">Message <span class="text-danger">*</span></label>
                                            <textarea
                ...
                <div class="container">
                    <div class="map-placeholder d-flex align-items-center justify-content-center">
                        <div class="text-center text-muted">
                            <i class="fas fa-map-marker-alt fa-3x mb-3" style="color:#28a745"></i>
                            <p class="mb-0 font-weight-bold">Westlands Business Park, Nairobi, Kenya</p>
            ...
            <section class="py-5 bg-white">
                <div class="container">
                    <div class="section-header text-center mb-5">
                        <span class="badge badge-success-soft mb-2"><i class="fas fa-question-circle mr-1"></i>FAQ</span>
                        <h2 class="font-weight-bold" style="color:#1a3a22">Frequently Asked Questions</h2>
                        <p class="text-muted mx-auto" style="max-width:480px">Can't find what you're looking for? Send us a message above.</p>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div v-for="(faq, i) in faqs" :key="i" class="faq-item mb-2">
                                <button class="faq-question w-100 text-left" type="button" @click="toggleFaq(i)">
                                    <span>{{ faq.q }}</span>
                                    <i :class="['fas', openFaq === i ? 'fa-chevron-up' : 'fa-chevron-down']"></i>
                                </button>
...
/* ── Hero ─────── */
.contact-hero {
    background: url('https://images.unsplash.com/photo-1423666639041-f56000c27a9a?auto=format&fit=crop&w=1400&q=80') center/cover no-repeat;
    min-height: 320px;
    display: flex;
    align-items: center;
}
...
.contact-hero-title { font-size: 2.6rem; font-weight: 800; color: #fff; margin-bottom: .5rem; }
.contact-hero-sub   { font-size: 1.1rem; color: rgba(255,255,255,.82); max-width: 520px; margin: 0 auto; }
...
.contact-detail-row { display: flex; align-items: flex-start; gap: .85rem; }
.contact-detail-icon {
    width: 36px; height: 36px; border-radius: 50%;
    background: rgba(255,255,255,.12);
    display: flex; align-items: center; justify-content: center;
    font-size: .9rem; color: #7fd99a; flex-shrink: 0;
}
.contact-detail-label { font-size: .75rem; color: rgba(255,255,255,.6); text-transform: uppercase; letter-spacing: .04em; }
.contact-detail-value { font-size: .9rem; color: #fff; font-weight: 500; }
.border-success-light { border-color: rgba(255,255,255,.12) !important; }
...
.faq-question:hover { background: #f8fdf9; }
.faq-answer {
    background: #f8fdf9;
...
.faq-slide-enter-active, .faq-slide-leave-active { transition: opacity .2s, max-height .25s; max-height: 300px; overflow: hidden; }
